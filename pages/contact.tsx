    ...
    <div className="mx-auto max-w-7xl">
      ...
      <div className="mx-auto my-20 flex h-auto max-w-4xl flex-wrap items-center lg:my-0 lg:h-screen">
        ...
        >
          <div className="p-4 text-center md:p-12 lg:text-left">
            ...
            <img
              ...
              src="https://cdn.sanity.io/images/agaeljtv/production/19ca9aa285166ab699ebc28501e2dd9260b8139b-1080x1084.jpg"
            />

            <h1 className="pt-8 text-3xl font-bold lg:pt-0">Kyle Hemsworth</h1>
            ...
            <p className="pt-8 text-sm">
              It sad but it is true that sometimes we need the tragedy to show
              us how fragile of a human we are and how we are more alike then
              different.
            </p>

            <div className="mx-auto mt-6 flex w-4/5 flex-wrap items-center justify-evenly pb-16 lg:w-full lg:pb-0">
              <a
                className="link"
                href="https://www.facebook.com/crimson.pizza"
                target="_blank"
              ...
              <a
                className="link"
                href="https://github.com/CrimsonPiZza"
                target="_blank"
              ...
              <a
                className="link"
                href="https://www.instagram.com/magical_dark_light/"
                target="_blank"
        ...
        <div className="w-full lg:w-2/5">
          ...
          <img
            src="https://i.ibb.co/xg2zQRy/admin-5-edited.jpg"
